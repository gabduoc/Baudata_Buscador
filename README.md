...
La app necesita ngrok funcionando en la maquina, el puerto 5000 libre para que este pueda utilizarlo y requiere una API key de Apollo con tokens disponibles para en enriquecimiento de datos de usuario (aprox necesita 300 - 350 tokens libres minimo)
